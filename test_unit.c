...
int main(void)
{
    ...
    test_unit_to_base_unit(3.280839, PresentationUnitFoot, 1, BaseUnitMetre);
    ...
    assert(!wcscmp(symbol_of_unit(PresentationUnitFoot), L"ft"));
    ...
    assert(can_render_base_unit_as(BaseUnitMetre, PresentationUnitFoot));
    ...
    expect(base_unit_render_as(1, BaseUnitMetre, PresentationUnitFoot),             "3.28084 ft");
